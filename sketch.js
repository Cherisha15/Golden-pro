...
var bgS, checkpointS, jumpS, deadS, diamondS;
...
function preload(){
 ...
 jumpS = loadSound("jumpS.wav");
 checkpointS = loadSound("success.mp3");
 diamondS=loadSound("diamond.mp3");
 deadS = loadSound("negative.mp3");
 deadS.looping=false;
 deadS.playing=true;
